...
class SessionExpAuth(SessionAuth):
    """
    SessionExpAuth is a class that extends functionality of the
    SessionAuth class.
    ...
    def __init__(self):
        ...
        # If  environment variable does not exist or cannot be converted to
    ...
    def create_session(self, user_id: int) -> str:
        ...
        session ID is stored in the user_id_by_session_id dictionary with
        the user_id and creation time as values.
        session has an expiration time defined by the session_duration
        attribute.
    ...
    def user_id_for_session_id(self, session_id: str) -> int:
        ...
        Session is considered valid if it was created within the
        ...
        Returns:
            int: user_id associated with the session ID if the session is
